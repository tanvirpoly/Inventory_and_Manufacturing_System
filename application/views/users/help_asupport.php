                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class=" btn btn-danger btn-xs" href="<?php echo site_url('User/delete_Ahelp_message').'/'.$value['hs_id']; ?>" onclick="return confirm('Are you sure you want to delete this message ?');" ><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>   
                    <?php } ?> 
                  </tbody>
    ...
    <div class="modal fade bs-example-modal-euser" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <form action="<?php echo base_url('User/reply_help_Asupport_msg');?>" method="post">
            <div class="col-md-12 col-sm-12 col-12">
