                ...
                <form method="POST" action="<?php echo site_url("Manufacturer/save_recipe_manufacturer") ?>">
                  <div class="col-md-12 col-sm-12 col-12">
                    <div class="row">
                      ...
                      <div class="form-group col-md-4 col-sm-4 col-xs-12">
                        <label>Batch *</label>
                        <input type="text" class="form-control" name="batch" value="<?php echo 'NB-'.sprintf("%'05d",$pcode); ?>" placeholder="batch" required readonly >
                      </div>
                      <div class="form-group col-md-4 col-sm-4 col-xs-12">
                      ...
                      <div class="form-group col-md-4 col-sm-4 col-xs-12">
                        ...
                        <input type="number" class="form-control" name="mDay" placeholder="Expire" required min="1" >
                      </div>
                    </div>
