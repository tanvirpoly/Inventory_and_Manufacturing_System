          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url() ?>Returns/update_returns" >
                        ...
                        <table id="mtable" class="table table-bordered table-striped">
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' onkeyup='totalPrice(<?php echo $id ?>)' name='salePrice[]' id='salePrice_<?php echo $id ?>' value="<?php echo $value['salePrice']; ?>" required >
                                    </td>
                                    <td>
