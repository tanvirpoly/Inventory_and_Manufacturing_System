          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Sales Vat Reports</h3>
              </div>

              <div class="card-body">
                <div class="col-sm-12 col-md-12 col-12">
                  <form action="<?php echo base_url() ?>salevReport" method="get">
                    <div class="col-md-12 col-sm-12 col-12">
                      ...
                      <table id="example" class="table table-responsive table-bordered" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($sale->totalAmount, 2); $tsa += $sale->totalAmount; ?></td>
                            <td><?php echo number_format($sale->paidAmount, 2); $tpa += $sale->paidAmount; ?></td>
                            <td><?php echo number_format($sale->dueamount, 2); $tda += $sale->dueamount; ?></td>
                            <td><?php echo number_format($sale->sCost, 2); $tva += $sale->sCost; ?></td>
                          </tr> 
                          <?php } ?>
                        </tbody>
                        <tbody>
