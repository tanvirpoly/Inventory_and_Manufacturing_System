                      ...
                      <table id="example" class="table table-responsive table-bordered" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($sale->totalAmount, 2); $tpa += $sale->totalAmount; ?></td>
                            ...
                            <td><?php echo number_format(($sale->totalAmount-($sale->paidAmount+$sale->discountAmount)), 2); $tba += ($sale->totalAmount-($sale->paidAmount+$sale->discountAmount)); ?></td>
                          </tr> 
                          <?php } ?>
                        </tbody>
                        <tbody>
