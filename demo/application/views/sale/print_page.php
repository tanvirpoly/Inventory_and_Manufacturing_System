														...
														<td colspan="2">
															<table class="table table-striped">
																...
																<tr>
																	...
																	<td><?php echo number_format($prints['sCost'], 2); ?></td>
																</tr>
																<tr>
								...
								<div id="pprint" class="d-none">
									...
									<div class="row invoice-info">
										<div class="col-sm-6 col-12 invoice-col">
											<b>Sales Date :</b> <?php echo date('d-m-Y', strtotime($prints['saleDate'])); ?><br>
                            ...
                            ?>
								...
								<div class="row no-print">
									<div class="col-12" style="text-align: center;">
										...
										<a href="<?php echo site_url('Sale') ?>" class="btn btn-danger"><i class="fas fa-arrow-left"></i>
											Back</a>
									</div>
								</div>
							</div>
