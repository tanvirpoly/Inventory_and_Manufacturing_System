  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Sales Due Payments Reports</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Sales Due Payments Reports</h3>
              </div>

              <div class="card-body">
                <div class="col-sm-12 col-md-12 col-12">
                  <form action="<?php echo base_url() ?>salepReport" method="get">
                    <div class="col-md-12 col-sm-12 col-12">
                      ...
                      <table id="example" class="table table-responsive table-bordered" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($sale->amount, 2); $tpa += $sale->amount; ?></td>
                          </tr> 
                          <?php } ?>
                        </tbody>
                        <tbody>
