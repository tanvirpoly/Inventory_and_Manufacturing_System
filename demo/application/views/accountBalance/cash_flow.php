                ...
                <div class="box-body">
                  <div id="print">
                    ...
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Cash Flow Statement in : <?php echo $sdate.' - '.$edate; ?></b></h3>
                    </div>
                    <?php } else if ($report == 'monthlyReports') { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Cash Flow Statement in : <?php echo $name.' '.$year; ?></b></h3>
                    </div>
                    <?php } else if ($report == 'yearlyReports') { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Cash Flow Statement in : <?php echo $year; ?></b></h3>
                    </div>
                    <?php } else { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Cash Flow Statement</b></h3>
                    </div>
                    <?php } }  ?>
                    ...
                    <div id="table-content">
                      <table id="" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <tr class="gradeX">
                            <th><?php echo "Total Cash Flow"; ?></th>
                            <th>
                              <?php $tca = $profit+$debit+$credit+$tob; ?>
