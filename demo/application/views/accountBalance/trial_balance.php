                    ...
                    <div id="table-content">
                      <table id="" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr class="gradeX">
                            <td><?php echo 'Opening Inventory'; ?></td>
                            <td>
                              <?php
                              $tob = 0;
                          ...
                          <tr class="gradeX">
                            ...
                            <td></td>
                            <td><?php echo number_format(($tob), 2); ?></td>
                          </tr>
                        </tbody>
                        <tbody>
                          <tr class="gradeX">
                            ...
                            <th>
                              <?php $tda = $cash+$bank+$mobile+$credit+$purchase->ttotal+$rsale+$expense->total+$tob; ?>
                              <?php echo number_format(($tda), 2); ?>
                            </th> 
                            <th>
                              <?php $tca = $debit+$sale->ttotal+$tob; ?>
