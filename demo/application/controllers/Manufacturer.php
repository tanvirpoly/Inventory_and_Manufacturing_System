...
public function get_Finish_Product($id)
  {
  $str = "";
...
public function get_Recipe_Product($id)
  {
  $str = "";
...
public function save_recipe_manufacturer()
  ...
  $mproduct = array(
    ...
    'regby'    => $_SESSION['uid']
        ...
        //var_dump($purchase_product);            
  $this->pm->insert_data('manufact_cproduct',$mproduct); 
  ...
  for($i = 0; $i < $lngth; $i++)
    ...
    $fproduct = array(
      ...
      'regby'    => $_SESSION['uid']
        ...
        //var_dump($purchase_product);            
    $this->pm->insert_data('manufact_product',$fproduct); 
  ...
  for($i = 0; $i < $ln2th; $i++)
    ...
    $mproduct = array(
      ...
      'regby'    => $_SESSION['uid']
        ...
        //var_dump($purchase_product);            
    $this->pm->insert_data('manufact_product',$mproduct); 
