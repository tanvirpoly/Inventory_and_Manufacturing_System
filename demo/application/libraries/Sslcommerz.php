	...
	* */
	...
	class Sslcommerz
	{
	    ...
	    public function __construct()
	    {
	        ...
	        $this->store_id = "sunshinecombdlive";
	        $this->store_pass = "61D2CEAA8AECA83134";
	        ...
	        $this->sslc_submit_url = "https://securepay.sslcommerz.com/gwprocess/v4/api.php";
	        $this->sslc_validation_url = "https://securepay.sslcommerz.com/validator/api/validationserverAPI.php";
	    }
	    ...
	    public function ValidateResponse($amount = 0, $currency = "BDT", $post_data=0)
	    {
